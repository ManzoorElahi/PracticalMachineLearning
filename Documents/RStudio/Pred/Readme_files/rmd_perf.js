...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 60 }, { marker: 'pandoc', elapsed: 110 }, { marker: 'post-processor', elapsed: 20 }, { marker: 'pre-processor', elapsed: 3390 }, { marker: 'render', elapsed: 3830 } ];
